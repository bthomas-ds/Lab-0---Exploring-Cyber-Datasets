...
+ Ability to conduct an exploratory analysis
...
#Clean up the environment
rm(list=ls())
# setwd('/home/bthomas/github/Lab-0---Exploring-Cyber-Datasets/Data')
#root.dir <- "/home/bthomas/github/Lab-0---Exploring-Cyber-Datasets/Data"
#knitr::opts_knit$set(root.dir = "/home/bthomas/github/Lab-0---Exploring-Cyber-Datasets/Data")
...
Now that we have data loaded, we need to structure the data. Tidyr (tidyr) is package with data manipulation functions. Data science [guidelines for data structure](http://tidyr.tidyverse.org/) for structure data are:
...
Data structure is a good technique to learn as other analysis functions will demand that your data fit into the key-value pairs. 
